...
local window = library:CreateWindow("uzisamaware.revamped", Vector2.new(492, 598), Enum.KeyCode.RightShift) -- 2nd argument is the size, 3rd is the show/hide ofc
...
local extratab = window:CreateTab("Credits")
...
extra1:AddLabel("uzi#3737 - founder/dev/owner")
extra1:AddLabel("tenaki#0710 - founder/dev")
extra1:AddLabel("loul#0001 - founder/dev")
extra1:AddLabel("loris#0001- founder/dev")
extra1:AddLabel("Slatti#0740 - founder/dev")
extra1:AddLabel("linux#0002 - founder/dev")
extra1:AddLabel("flash#0070 - founder/dev")
extra1:AddLabel("dm uzi#3737 to make ur scripts")
--//Code
