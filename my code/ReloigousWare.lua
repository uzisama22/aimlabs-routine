...
local Window = Library:CreateWindow("ReligousWare", Vector2.new(492, 750), Enum.KeyCode.RightShift)
...
local RageSection = AimingTab:CreateSector("ReligousWare Target Aim", "left")
local TargetAimToggle = RageSection:AddToggle('ReligousWare Target Aim Enabled', false, function(Boolean)
...
if syn then
    ...
    Notify({
        Title = "ReligousWare",
        Description = "Welcome To ReligousWare",
        Duration = 7
    })
end
