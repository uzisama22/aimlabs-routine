getgenv().SilentAimbotKey = 'z'; getgenv().AimlockKey = 'q';  _G.WEBHOOK_URL = 'https://discord.com/api/webhooks/942220240547364874/rOLhApIPvq5KEtTSP7vlP1KCYgEVCcTYyg_htPTpDe4SJH2mF6Dxll_ksAvFj8BfBGUg';
	...
	function(k)
		...
		if enabled then
			...
			if getgenv().Webhookmode == true then 
				...
				sendMessage("wow u unlocked -uzi was here")
...
--// variables etc
    ...
    local LoaderTitle = "uziware.cc (priv)"
